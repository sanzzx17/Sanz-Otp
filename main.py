...
def print_banner(tick=0):
    ...
    title = gradient_text("SANZNOCOUNTERRRR", tick, 0)
  ...
  ┌──────────────────────────────────────────────────────┐
  │  {color}API{reset}  : 24  │  {color}Version{reset}  : 1.0.0  │  {color}Dev{reset}  : Sanz    │
  └──────────────────────────────────────────────────────┘{reset}
"""
    print(banner)
